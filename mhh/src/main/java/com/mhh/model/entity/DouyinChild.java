...
/**
 * 订单子表;promotion_talent_amount+promotion_platform_amount+promotion_pay_amount=平台总优惠=platform_cost_amount++promotion_pay_amount(DouyinChild)实体类
 *
 * @author makejava
 * @since 2022-08-19 15:26:12
 */
@Data
public class DouyinChild implements Serializable {
    private static final long serialVersionUID = -88136025810372949L;
     ...
     * 最新成本
     */
    private Double nProductCostNew;
    /**
     * 最新物流费
     */
    private Double nLogisticsMoneyNew;
    /**
     * 最新服务费
     */
    private Double nServiceMoneyNew;
    ...
    private String fkSysUserLeader;
    /**
     * 用户id
     */
    private String fkSysUser;
